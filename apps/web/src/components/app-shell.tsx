    ...
    <div className="min-h-screen">
      ...
      <div className={cn("min-w-0 max-w-full transition-[padding] duration-200 lg:pr-[248px]", collapsed && "lg:pr-[76px]")}>
        <header className="sticky top-0 z-30 flex h-16 min-w-0 items-center gap-2 border-b bg-background/88 px-4 backdrop-blur-md sm:px-6">
          ...
          <ThemeButton />
          <DropdownMenu.Root><DropdownMenu.Trigger asChild><Button variant="ghost" className="relative w-10 px-0" aria-label="الإشعارات"><Bell className="h-5 w-5" /><span className="absolute left-2 top-2 h-2 w-2 rounded-full bg-warning ring-2 ring-background" /></Button></DropdownMenu.Trigger><DropdownMenu.Portal><DropdownMenu.Content align="end" className="z-50 w-72 rounded-xl border bg-card p-2 shadow-lift"><DropdownMenu.Label className="p-2 text-sm font-bold">الإشعارات</DropdownMenu.Label><div className="rounded-lg bg-amber-500/8 p-3 text-xs leading-6">حزمة التدريب v2 جاهزة للتنفيذ الخارجي. لا توجد نتائج علمية نهائية بعد.</div></DropdownMenu.Content></DropdownMenu.Portal></DropdownMenu.Root>
